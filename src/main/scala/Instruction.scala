...
case class TermEqInst( pos: Reader ) extends Instruction
case class TermLtInst( pos: Reader ) extends Instruction
case class TermLeInst( pos: Reader ) extends Instruction
